...
Route::get('/auth', [KhachHangController::class, 'index'])->name('viewCustomerLogin');
Route::get('/forgot-password', [KhachHangController::class, 'forgotPassword']);
Route::post('/forgot-password', [KhachHangController::class, 'actionForgotPassword'])->name('actionForgotPassword');
Route::get('/update-password/{hash_reset}', [KhachHangController::class, 'viewUpdatePassword'])->name('viewUpdatePassword');
Route::post('/update-password', [KhachHangController::class, 'actionUpdatePassword'])->name('actionUpdatePassword');
...
Route::post('/create', [ThongTinLienHeController::class, 'store']);
...
Route::group(['middleware' => 'customer'], function () {
    Route::get('/profile', [KhachHangController::class, 'index_profile']);
    Route::get('/profile/customer', [KhachHangController::class, 'index_profile_customer'])->name('viewProfileCustomer');
    Route::get('/profile/don-hang', [KhachHangController::class, 'index_profile_don_hang'])->name('viewProfileDonHang');
    Route::get('/profile/re-password', [KhachHangController::class, 'index_profile_repassword'])->name('viewProfileRePassword');
    Route::post('/profile/update-password', [KhachHangController::class, 'updatePasswordCustomer'])->name('updatePasswordCustomer');
    Route::get('/logout', [KhachHangController::class, 'logout']);
    Route::post('/add-to-cart', [ChiTietBanHangController::class, 'addToCart']);
    Route::get('/list-cart', [ChiTietBanHangController::class, 'listCart'])->name('listCart');
    ...
    Route::post('/profile/customer/data', [KhachHangController::class, 'DataCustomerProfile']);
    Route::post('/profile/customer/update', [KhachHangController::class, 'UpdateCustomerProfile']);

    //vnpay
    Route::get('/vnpay/{id}', [ThanhToanController::class, 'indexvnpay']);
    Route::post('/vnpay/thanh-toan/', [ThanhToanController::class, 'actionThanhToan']);
    Route::get('/vnpay/thanh-toan/respone', [ThanhToanController::class, 'responeVNPay']);
...
Route::group(['prefix' => '/admin', 'middleware' => 'authadmin'], function () { //, 'middleware' => 'authadmin'
    ...
    Route::group(['prefix' => '/khach-hang'], function () {
        Route::get('/', [KhachHangController::class, 'viewKhachHangAdmin']);
        Route::post('/data', [KhachHangController::class, 'dataKhachHang']);
        Route::post('/destroy', [KhachHangController::class, 'destroyKhachHang']);
    });
    ...
    Route::group(['prefix' => '/don-hang'], function () {
        ...
        Route::get('/data', [DonHangController::class, 'getDataDonHangAdmin']);
        ...
        Route::get('/in-bill/{id}', [DonHangController::class, 'inBill']);
    });
    //Route Thống Kê
    Route::group(['prefix' => '/thong-ke'], function () {
        Route::get('/so-luong-kh', [ThongKeController::class, 'viewSLKH'])->name('viewSoLuongKhachHang');
        Route::post('/so-luong-kh', [ThongKeController::class, 'dataSLKH'])->name('dataSoLuongKhachHang');
        Route::post('/chi-tiet-so-luong-kh', [ThongKeController::class, 'chiTietSLKH'])->name('chiTIetSoLuongKhachHang');

        Route::get('/so-luong-dh', [ThongKeController::class, 'viewSLDH'])->name('viewSoLuongDonHang');
        Route::post('/so-luong-dh', [ThongKeController::class, 'dataSLDH'])->name('dataSoLuongDonHang');
        Route::post('/chi-tiet-so-luong-dh', [ThongKeController::class, 'chiTietSLDH'])->name('chiTIetSoLuongDonHang');

        Route::get('/tong-tien', [ThongKeController::class, 'viewTH'])->name('viewTongTien');
        Route::post('/tong-tien', [ThongKeController::class, 'dataTH'])->name('dataTongTien');
        Route::post('/chi-tiet-tong-tien', [ThongKeController::class, 'chiTietTH'])->name('chiTIetTongTien');

        Route::get('/tong-tien-sp', [ThongKeController::class, 'viewTHSP'])->name('viewTongTienSanPham');
        Route::post('/tong-tien-sp', [ThongKeController::class, 'dataTHSP'])->name('dataTongTienSanPham');
        Route::post('/chi-tiet-tong-tien-sp', [ThongKeController::class, 'chiTietTHSP'])->name('chiTIetTongTienSanPham');
    });
    ...
    Route::group(['prefix' => '/profile'], function () {
        ...
        Route::post('/data', [ProfileController::class, 'data']);
        Route::post('/update', [ProfileController::class, 'update']);
        Route::post('/re-password', [ProfileController::class, 'repassword']);
    });
    Route::group(['prefix' => '/lien-he'], function () {
        Route::get('/', [ThongTinLienHeController::class, 'index']);
        Route::post('/data', [ThongTinLienHeController::class, 'data']);
        Route::post('/data', [ThongTinLienHeController::class, 'data']);
        Route::post('/delete', [ThongTinLienHeController::class, 'destroy']);
        Route::post('/status', [ThongTinLienHeController::class, 'status'])->name('statusLienHe');
    });
});
