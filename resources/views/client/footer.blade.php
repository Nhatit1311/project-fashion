                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                        <div class="footer-widget-inner">
                            ...
                            <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                <li class="footer-menu-item"><a href="about-us.html">Giới thiệu về chúng tôi</a></li>
                                <li class="footer-menu-item"><a href="about-us.html">Tin tin sản phẩm</a></li>
                                <li class="footer-menu-item"><a href="blog.html">Thông tin sản phẩm</a></li>
                                <li class="footer-menu-item"><a href="about-us.html">Hợp tác kinh doanh</a></li>
                                <li class="footer-menu-item"><a href="about-us.html">Tuyển dụng</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                        <div class="footer-widget-inner">
                            ...
                            <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                <li class="footer-menu-item"><a href="about-us.html">Danh mục sản phẩm</a></li>
                                <li class="footer-menu-item"><a href="about-us.html">Mã giảm giá</a></li>
                                <li class="footer-menu-item"><a href="collection-left-sidebar.html">Hướng dẫn thanh toán</a></li>
                                <li class="footer-menu-item"><a href="collection-left-sidebar.html">Chính sách vận chuyển</a></li>
                                <li class="footer-menu-item"><a href="collection-left-sidebar.html">Hệ thống cửa hàng</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                        <div class="footer-widget-inner">
                            ...
                            <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                <li class="footer-menu-item"><a href="faq.html">Điều khoản sử dụng</a></li>
                                <li class="footer-menu-item"><a href="about-us.html">Chính sách hoàn trả</a></li>
                                <li class="footer-menu-item"><a href="about-us.html">Hướng dẫn mua hàng</a></li>
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-6 col-12 footer-widget">
                        <div class="footer-widget-inner">
                            ...
                            <div class="footer-newsletter">
                                <p class="footer-text mb-3">Luôn cập nhật tin tức mới</p>
        ...
        <div class="container">
            <div
                ...
                <ul class="footer-bottom-menu list-unstyled d-flex flex-wrap align-items-center mb-0">
                    ...
                    <li class="footer-menu-item"><a href="about-us.html">Điều khoản và điều kiện</a></li>
                </ul>
                <p class="copyright footer-text">©<span class="current-year"></span> Shop Fashion Bisum.</p>
            </div>
        </div>
    </div>
</footer>
