                            ...
                            <div class="product-details ps-lg-4">
                                ...
                                <div class="product-price-wrapper mb-4">
                                    @if ($value->gia_khuyen_mai > 0)
                                        <span
                                            class="card-price-regular">{{ number_format($value->gia_khuyen_mai, 0, '.', ',') }}
                                            đ</span>
                                        <span
                                            class="card-price-compare text-decoration-line-through">{{ number_format($value->gia_ban, 0, '.', ',') }}
                                            đ</span>
                                    @else
                                        <span class="card-price-regular">{{ number_format($value->gia_ban, 0, '.', ',') }}
                                            đ</span>
                                    @endif
                                </div>
                                ...
                                <div class="misc d-flex align-items-end justify-content-between mt-4">
                                    <div class="quantity d-flex align-items-center justify-content-between">
                                        <button id="tru_sp" class="qty-btn dec-qty"><img src="/assets_client/img/icon/minus.svg"
                                                alt="minus"></button>
                                        <input id="so_luong_sp" class="qty-input" type="number" name="qty"
                                            value="1" min="0">
                                        <button id="cong_sp" class="qty-btn inc-qty"><img src="/assets_client/img/icon/plus.svg"
                                                alt="plus"></button>
                                    </div>
                                </div>
                                ...
                                <div class="product-form">
                                    <div
                                        ...
                                        @if (Auth::guard('customer')->check())
                                            <button id="addtocart_me" class="position-relative btn-atc btn-add-to-cart">THÊM
                                                GIỎ HÀNG</button>
                                        @else
                                            <button data-bs-toggle="modal" data-bs-target="#authModal"
                                                class="position-relative btn-atc btn-add-to-cart">THÊM GIỎ HÀNG</button>
                                        @endif
                                    </div>
                                    <div class="buy-it-now-btn mt-2">
                                        @if (Auth::guard('customer')->check())
                                            <button type="button" v-on:click="themGioHang({{ $value->id }})"
                                                class="position-relative btn-atc btn-buyit-now">MUA NGAY</button>
                                        @else
                                            <button data-bs-toggle="modal" data-bs-target="#authModal"
                                                class="position-relative btn-atc btn-buyit-now">MUA NGAY</button>
                                        @endif
                                ...
                                <div class="guaranteed-checkout">
                                    <strong class="label mb-1 d-block">Thanh Toán Online:</strong>
                ...
                <div class="container">
                    <div class="tab-list product-tab-list">
                        <nav class="nav product-tab-nav">
                            <a class="product-tab-link tab-link active" href="#pdescription" data-bs-toggle="tab">Mô
                                Tả</a>
                            <a class="product-tab-link tab-link" href="#pshipping" data-bs-toggle="tab">Vận Chuyển & Trả
                                Hàng</a>
                            <a class="product-tab-link tab-link" href="#pstyle" data-bs-toggle="tab">Phong Cách</a>
                    ...
                    <div class="tab-content product-tab-content">
                        ...
                        <div id="pshipping" class="tab-pane fade">
                            <div class="desc-content">
                                ...
                                <p class="text_16 mb-4">Standard Shipping: If you placed an order using "standard shipping"
                                    and you want to return it, you will be refunded the product price and initial shipping
                                    costs. However, the return shipping costs will be paid by you.</p>
                                <p class="text_16">Free Shipping: If you placed an order using "free shipping" and you want
                                    to return it, you will be refunded the product price, but since we paid for the initial
                                    ...
                                    <div class="product-card">
                                        <div class="product-card-img">
                                            <a class="hover-switch"
                                                href="/product/{{ $value->slug_san_pham }}-post{{ $value->id }}">
                                                <img style="height: 360px; width: 100%;" class="secondary-img"
                                                    src="{{ explode(',', $value->hinh_anh)[0] }}" alt="product-img">
                                                <img style="height: 360px; width: 100%;" class="primary-img"
                                                    src="{{ explode(',', $value->hinh_anh)[0] }}" alt="product-img">
                                            </a>
                                            @php
                                                $arr = ['Sale', 'Hot', 'New', ''];
                                            ...
                                            <div class="product-badge">
                                                ...
                                                @if ($value->gia_khuyen_mai > 0)
                                                    <span
                                                        class="badge-label badge-percentage rounded">-{{ number_format((($value->gia_ban - $value->gia_khuyen_mai) / $value->gia_ban) * 100, 0, '.', ',') }}%</span>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="product-card-details">
                                            ...
                                            <div class="product-card-price">
                                                ...
                                                @else
                                                    <span
                                                        class="card-price-regular">{{ number_format($value->gia_ban, 0, '.', ',') }}
                                                        đ</span>
                                                @endif
                                            </div>
                                        </div>
