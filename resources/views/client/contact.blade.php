                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="contact-item">
                                ...
                                <div class="contact-details">
                                    <h2 class="contact-title">Địa Chỉ Email</h2>
                                    <a class="contact-info" href="mailto:info@example.com">admin@gmail.com</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="contact-item">
                                ...
                                <div class="contact-details">
                                    <h2 class="contact-title">Trụ Sở Chính</h2>
                                    <p class="contact-info">254 Nguyễn Văn Linh, TP Đà Nẵng</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="contact-item">
                                ...
                                <div class="contact-details">
                                    ...
                                    <a class="contact-info" href="tel:(201) 555-0124">0900122133</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="contact-form-area">
                    <div class="section-header mb-4">
                        ...
                        <p class="section-subheading">Những thắc mắc và phản hồi của bạn sẽ được chúng tôi tiếp nhận tại
                            đây.</p>
                    </div>
                        ...
                        <div action="#" class="contact-form">
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <fieldset>
                                        <input v-model="list.ho_va_ten" type="text" placeholder="Họ và tên" />
                                    </fieldset>
                                </div>
                                <div class="col-md-6 col-12">
                                    <fieldset>
                                        <input v-model="list.email" type="email" placeholder="Email*" />
                                    </fieldset>
                                </div>
                                <div class="col-12">
                                    <fieldset>
                                        <input v-model="list.so_dien_thoai" type="text" placeholder="Số điện thoại" />
                                    </fieldset>
                                </div>
                                <div class="col-md-12 col-12">
                                    <fieldset>
                                        <textarea v-model="list.ghi_chu" cols="20" rows="6" placeholder="Gửi thông điệp tại đây*"></textarea>
                                    </fieldset>
                                    <button v-on:click="GuiPhanHoi()" type="submit"
                                        class="position-relative review-submit-btn contact-submit-btn">Gửi Phản Hồi</button>
                                </div>
                            </div>
                        </div>
                    </div>
