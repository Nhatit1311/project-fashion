...
@section('noi_dung_profile')
    <div id="app">
        <div class="desc-content">
                        ...
                        <template v-for="(value, index) in list">
                            <tr>
                                ...
                                <td class="text-center align-middle">
                                    <button v-if="value.thanh_toan == 0" class="btn btn-danger">Chưa Thanh
                                        Toán</button>
                                ...
                                <td class="text-center align-middle">
                                    ...
                                    <button v-else-if="value.giao_hang == 1" class="btn btn-success">Đang Vận
                                        Chuyển</button>
                                    <button v-else class="btn btn-info">Đã Nhận</button>
                                </td>
                                <td class="text-center align-middle">
                                    <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#chiTietDonhang"
                                        v-on:click="chiTietDonHang(value.id)">Chi Tiết</button>
                                </td>
                            </tr>
                        </template>
                    </tbody>
            ...
            <!-- Modal -->
            <div class="modal fade" id="chiTietDonhang" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
