<div class="topbar d-flex align-items-center">
    <nav class="navbar navbar-expand">
        ...
        <div class="mobile-toggle-menu"><i class='bx bx-menu' id="btnMenu"></i></div>
            ...
            <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                ...
                <div class="user-info ps-3">
                    @php
                        ...
                        if ($data) {
                            $quyen = App\Models\Quyen::find($data->id_quyen);

                            if ($quyen) {
                                $tenQuyen = $quyen->ten_quyen;
                            }
                        }
                    @endphp
                    @if ($data)
                        <p class="user-name mb-0">{{ $data->ho_va_ten }}</p>
                        <p class="designattion mb-0">{{ $tenQuyen }}</p>
                    @endif
                </div>
            </a>
            <ul class="dropdown-menu dropdown-menu-end">
                <li><a class="dropdown-item" href="/admin/profile"><i class="bx bx-user"></i><span>Thông tin</span></a>
                </li>
                <li>
