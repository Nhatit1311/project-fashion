                    ...
                    <table class="table table-bordered" id="table_chuyen_muc">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center align-middle text-nowrap">Chuyên Mục Cha</th>
                        ...
                        <tbody>
                            <tr v-for="(value, key) in listChuyenMuc">
                                ...
                                <td class="text-center align-middle text-nowrap">@{{ value.ten_chuyen_muc_cha == null ? 'Root' : value.ten_chuyen_muc_cha }}</td>
                                <td class="text-center align-middle text-nowrap">
