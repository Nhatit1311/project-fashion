                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr v-for="(v, k) in detail">
                                            ...
                                            <td>@{{  numberFormat(v.phi_ship) }}</td>
                                            <td>@{{  numberFormat(v.tong_thanh_toan) }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
        ...
        new Vue({
            ...
            methods: {
                getData() {
                    ...
                    axios
                        .post('{{ Route('dataSoLuongDonHang') }}', payload)
                        .then((res) => {
                ...
                xemChiTiet(payload) {
                    axios
                        .post('{{ Route('chiTIetSoLuongDonHang') }}', payload)
                        .then((res) => {
        ...
        function getChart() {
            ...
            axios
                ...
                .then((res) => {
                    ...
                    du_lieu = res.data.so_luong_don_hang;
