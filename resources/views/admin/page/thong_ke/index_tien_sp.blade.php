                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr v-for="(v, k) in list">
                                ...
                                <td>@{{ numberFormat(v.tong_tien_ban) }}</td>
    ...
    <script>
        new Vue({
            ...
            methods: {
                getData() {
                    ...
                    axios
                        .post('{{ Route('dataTongTienSanPham') }}', payload)
                        .then((res) => {
                ...
                xemChiTiet(payload) {
                    axios
                        .post('{{ Route('chiTIetTongTienSanPham') }}', payload)
                        .then((res) => {
        ...
        function getChart() {
            ...
            axios
                .post('{{ Route('dataTongTienSanPham') }}', payload)
                .then((res) => {
                    ten_du_lieu = res.data.ten_san_pham;
                    du_lieu = res.data.tong_tien_ban;
