                        ...
                        <tbody>
                            <template v-for="(v, k) in listTinTuc">
                                <tr>
                                    ...
                                    <td class="text-center align-middle text-nowrap">
                                        <button v-on:click="modal = v"  data-bs-toggle="modal" data-bs-target="#moTaNgan" class="btn btn-primary"><i style="padding-left: 6px" class="fa-sharp fa-solid fa-info"></i></button>
                                    </td>
                                    <td class="text-center align-middle text-nowrap">
