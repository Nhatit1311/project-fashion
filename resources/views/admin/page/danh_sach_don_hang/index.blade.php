                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr class="text-center">
                                ...
                                <th class="align-middle text-center text-nowrap">Mã Đơn Hàng</th>
                                <th class="align-middle text-center text-nowrap">Tiền hàng</th>
                                <th class="align-middle text-center text-nowrap">Phí Ship</th>
                                <th class="align-middle text-center text-nowrap">Tên Khách Hàng</th>
                                <th class="align-middle text-center text-nowrap">Địa Chỉ</th>
                                <th class="align-middle text-center text-nowrap">Thanh Toán</th>
                                <th class="align-middle text-center text-nowrap">Giao Hàng</th>
                        ...
                        <tbody>
                            <template v-for="(value, index) in list">
                                <tr>
                                    ...
                                    <td class="text-center align-middle text-nowrap">@{{ value.hash_don_hang }}</td>
                                    <td class="align-middle text-nowrap">@{{ numberformat(value.tien_hang) }}</td>
                                    <td class="align-middle text-nowrap">@{{ numberformat(value.phi_ship) }}</td>
                                    <td class="align-middle text-nowrap">@{{ value.ho_lot }} @{{ value.ten_khach}}</td>
                                    <td class="align-middle text-nowrap">@{{ value.dia_chi }}</td>
                                    <td class="text-center align-middle text-nowrap">
                                        <button  v-if="value.thanh_toan == 1" class="btn btn-success">Đã Thanh Toán</button>
                                        <button  v-else class="btn btn-danger">Chưa Thanh Toán</button>
                                    </td>
                                    <td class="text-center align-middle text-nowrap">
                                    ...
                                    <td class="text-center align-middle text-nowrap">
                                        ...
                                        <a target="_blank" v-bind:href="'/admin/don-hang/in-bill/' + value.id" class="btn btn-warning">In Bill</a>
                                    </td>
                                </tr>
                            </template>
                        </tbody>
